    ...
    <section class="checkout">
        ...
        <form action="" method="post">
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>City :</span>
                    <input type="text" name="city" required placeholder=" Da Nang">
                </div>
                <div class="inputBox">
                    <span> District :</span>
                    <input type="text" name="state" required placeholder=" Ngu Hanh Son ">
                </div>
                <div class="inputBox">
                    <span>Country :</span>
                    <input type="text" name="country" required placeholder="Viet Nam ">
                </div>
                <div class="inputBox">
                    <span>Pin code :</span>
